 ...
 */
corsaro_file_t *corsaro_file_open(struct corsaro *corsaro, const char *filename,
                                  corsaro_file_mode_t mode,
 ...
 */
off_t corsaro_file_write(struct corsaro *corsaro, corsaro_file_t *file,
 ...
 * @return The amount of bytes written, 0 if EOF is reached, -1 if an error
 * occurs
 *
 * This can be used on Corsaro Binary and Libtrace mode file to write a single
 * packet.
 */
off_t corsaro_file_write_packet(struct corsaro *corsaro, corsaro_file_t *file,
 ...
 * @return The amount of bytes read, 0 if EOF is reached, -1 if an error occurs
 *
 * This can be used on Corsaro Binary and Libtrace mode file to retrieve a
 * single
